...
//         vault = new ProportionalChunkedClawbackVault(admin, beneficiary, startTimestamp, durationSeconds);
...
//         // emit vault.Clawback(address(token), totalAmount);
//         vault.clawback(address(token));
//         vm.stopPrank();
...
//         vm.startPrank(admin);
//         // vm.expectEmit(true, false, false, true);
//         // emit ProportionalChunkedClawbackVault.Clawback(address(token), expectedUnvested);
//         vault.clawback(address(token));
//         vm.stopPrank();
