...
contract TokenMigrationProposalTest is Test {
    ...
    function setUp() public {
        ...
        optimismFork = vm.createSelectFork(optimismRpcUrl, 138335950);
        ...
        mainnetFork = vm.createSelectFork(mainnetRpcUrl, 22898725); // 22746288 for this test makes it pass, thats where the snapshots are from
