...
contract L2ECOxZeroUpgradeTest is Test {
    ...
    function test_BurnBalancesFunctionality() public {
        ...
        try upgradedProxy.burnBalances(accountsToBurn) {
            ...
            assertEq(finalTotalSupply, initialTotalSupply - totalBurned, "Total supply should be reduced by burned amount");
    ...
    function test_FullL1ToL2UpgradeFlow() public {
        ...
        address(l2Messenger).call(abi.encodeWithSignature(
        ...
        assertEq(totalSupplyAfter, totalSupplyBefore - balance1Before - balance2Before, "Total supply should be reduced by burned amounts");
