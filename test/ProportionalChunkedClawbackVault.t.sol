...
contract ProportionalChunkedClawbackVaultTest is Test {
    ...
    function setUp() public {
        ...
        chunks.push(ProportionalChunkedClawbackVault.VestingChunk({timestamp: startTimestamp, totalPercentVested: 0}));

        chunks.push(
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: startTimestamp + 90 days, totalPercentVested: 25})
        );

        chunks.push(
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: startTimestamp + 180 days, totalPercentVested: 50})
        );

        chunks.push(
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: startTimestamp + 270 days, totalPercentVested: 75})
        );

        chunks.push(ProportionalChunkedClawbackVault.VestingChunk({timestamp: endTimestamp, totalPercentVested: 100}));

        // Deploy ProportionalChunkedClawbackVault
        vault = new ProportionalChunkedClawbackVault(
            admin, beneficiary, startTimestamp, endTimestamp - startTimestamp, chunks
        );
    ...
    function test_Constructor_RevertsIfNoChunks() public {
        ProportionalChunkedClawbackVault.VestingChunk[] memory emptyChunks =
            new ProportionalChunkedClawbackVault.VestingChunk[](0);
        vm.expectRevert(ProportionalChunkedClawbackVault.NoChunks.selector);
        new ProportionalChunkedClawbackVault(
            admin, beneficiary, startTimestamp, endTimestamp - startTimestamp, emptyChunks
        );
    }

    function test_Constructor_RevertsIfLastChunkNot100Percent() public {
        ProportionalChunkedClawbackVault.VestingChunk[] memory invalidChunks =
            new ProportionalChunkedClawbackVault.VestingChunk[](2);
        invalidChunks[0] =
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: startTimestamp, totalPercentVested: 0});
        invalidChunks[1] =
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: endTimestamp, totalPercentVested: 90});

        vm.expectRevert(ProportionalChunkedClawbackVault.LastChunkNotFullyVested.selector);
        new ProportionalChunkedClawbackVault(
            admin, beneficiary, startTimestamp, endTimestamp - startTimestamp, invalidChunks
        );
    }
    ...
    function test_Constructor_RevertsIfChunksNotInOrder() public {
        ProportionalChunkedClawbackVault.VestingChunk[] memory invalidChunks =
            new ProportionalChunkedClawbackVault.VestingChunk[](2);
        invalidChunks[0] =
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: endTimestamp, totalPercentVested: 50});
        invalidChunks[1] =
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: startTimestamp, totalPercentVested: 100});
    ...
    function test_Constructor_RevertsIfPercentDecreasing() public {
        ProportionalChunkedClawbackVault.VestingChunk[] memory invalidChunks =
            new ProportionalChunkedClawbackVault.VestingChunk[](3);
        invalidChunks[0] =
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: startTimestamp, totalPercentVested: 50});
        invalidChunks[1] =
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: startTimestamp + 1, totalPercentVested: 40});
        invalidChunks[2] =
            ProportionalChunkedClawbackVault.VestingChunk({timestamp: endTimestamp, totalPercentVested: 100});
    ...
    function test_ComplexEdgeCase_BalanceIncrease_Release_Clawback_Release() public {
        ...
        assertEq(
            vestedAfterPostClawback,
            postClawbackTokens + vault.released(address(token)),
            "Post-clawback tokens should be immediately vested"
        );
        ...
        assertEq(
            ...
            totalBeneficiaryTokens + postClawbackTokens,
            "Beneficiary should have all tokens including post-clawback"
        );
